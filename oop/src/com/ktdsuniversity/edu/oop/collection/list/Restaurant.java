...
import com.ktdsuniversity.edu.oop.restaurant.Consumer;
import com.ktdsuniversity.edu.oop.restaurant.Drink;
import com.ktdsuniversity.edu.oop.restaurant.Food;
...
class Restaurant {
	...
	Restaurant(){
		foods = new ArrayList<>();
		foods.add(new Food("육고기",25,0));
		foods.add(new Food("채소",13,-5));
		foods.add(new Food("과일",13,-5));
		foods.add(new Food("생선",7,0));
		
		drinks = new ArrayList<>();
		drinks.add(new Drink("소주",-7,17));
		drinks.add(new Drink("맥주",8,6));
		drinks.add(new Drink("위스키",-7,40));
		drinks.add(new Drink("꼬냑",-7,40));
	}
